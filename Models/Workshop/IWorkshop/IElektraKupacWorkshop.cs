...
namespace aes.Models
{
    public interface IElektraKupacWorkshop
    {
        ...
        JsonResult GetRacuniForKupac<T>(int param, IDatatablesGenerator datatablesGenerator, HttpRequest Request, ApplicationDbContext _context, IRacunWorkshop workshop, DbSet<T> modelcontext) where T : Elektra;
    }
}
