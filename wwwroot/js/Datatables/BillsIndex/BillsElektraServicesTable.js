        ...
        "columns": [
            ...
            { "data": "redniBroj", "name": "redniBroj" },
            {
                ...
                "render": function (data) {
                    return '<a href="BillsElektraServices/Details/' + data.id + '">' + data.brojRacuna + '</a>';
                },
            },
            {
                ...
                "render": function (data) {
                    if (data.elektraKupac != null)
                        return '<a href="ElektraCustomers/Details/' + data.elektraKupac.id + '">' + data.elektraKupac.ugovorniRacun + '</a>';
                    return '';
                }
            },
