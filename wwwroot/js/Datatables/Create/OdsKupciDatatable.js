        ...
        "columns": [
            {
                ...
                "render": function (data, type, row, meta) {
                    return '<a href="@Url.Action("Details", "Ods")' + "/" + data.id + '">' + data.omm + '</a>';
                }
            },
            {
                "data": null, "name": "StanId",
                "render": function (data, type, row, meta) {
                    return '<a href="@Url.Action("Details", "Stanovi")' + "/" + data.stan.id + '">' + data.stan.stanId + '</a>';
                }
            },
            {
                "data": null, "name": "Stan.SifraObjekta",
                "render": function (data, type, row, meta) {
                    return '<a href="@Url.Action("Details", "Stanovi")' + "/" + data.stan.id + '">' + data.stan.sifraObjekta + '</a>';
                }
            },
