$(document).ready(function () {
    ...
    table = selectIndexTable.DataTable({
        "ajax": {
            "url": "/BillsElektraServices/GetList",
            "type": "POST",
            "datatype": "json",
            "data": function (d) {
            }
        ...
        "columns": [
            { "data": "redniBroj", "name": "redniBroj" },
            {
                ...
                "render": function (data) {
                    return '<a href="../../../BillsElektraServices/Edit/' + data.id + '">' + data.brojRacuna + '</a>';
                }
            },
            {
                ...
                "render": function (data) {
                    if (data.elektraKupac == null || data.elektraKupacId == 2002)
                        return "";
                    return '<a href="../../../Apartments/Details/' + data.elektraKupac.ods.stan.id + '">' + data.elektraKupac.ods.stan.stanId + '</a>';
                }
            },
            {
