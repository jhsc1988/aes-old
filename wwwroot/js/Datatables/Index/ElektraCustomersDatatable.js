        ...
        "columns": [
            {
                ...
                "render": function (data, type, row, meta) {
                    return '<a href="ElektraCustomers/Details/' + data.id + '">' + data.ugovorniRacun + '</a>';
                }
            },
            {
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    return '<a href="Apartments/Details/' + data.ods.stan.id + '">' + data.ods.stan.stanId + '</a>';
                }
            },
            {
                "data": null, "name": "ods.stan.sifraObjekta",
                "render": function (data, type, row, meta) {
                    return '<a href="Apartments/Details/' + data.ods.stan.id + '">' + data.ods.stan.sifraObjekta + '</a>';
                }
            },
