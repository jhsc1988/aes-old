...
{
    public class BillsElektraAdvancesUploadService : IBillsElektraAdvancesUploadService
    {
        ...
        public BillsElektraAdvancesUploadService(IWebHostEnvironment webHostEnvironment, IBillsElektraAdvancesTempCreateService billsElektraAdvancesTempCreateService,
                    ...
                    using (reader = new StreamReader(fileName))
                    {
                        ...
                        while (!reader.EndOfStream)
                        {
                            ...
                            if (line.Contains("HR01"))
                            {
                                ...
                                _ = await _billsElektraAdvancesTempCreateService.AddNewTemp(reader.ReadLine(), iznos.ToString(), null, userId);
